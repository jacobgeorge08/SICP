...
; state transformation in such a way that the product ab^n
; is unchanged from state to state. At the beginning of the process a
; is taken to be 1, and the answer is given by the value of a at the end of
; the process. In general, the technique of defining an invariant quantity
...
(define (fast-expt b n)
  (define (fast-expt-i b n a)
    (cond ((= n 0) a)
          ((even? n) (fast-expt-i (square b) (/ n 2) a))
